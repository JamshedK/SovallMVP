...
import sovall_main from './assets/sovall_main.svg';
...
const About = (props) => {
    ...
    return (
        <div className="h-90% flex max-md:flex-col max-md:gap-4 md:pt-4 md:justify-center items-center select-none">
                {/*Wheel*/}
                <div className="relative flex justify-center w-full max-md:h-[30rem] md:h-95% md:w-1/2 md:pt-8 2xl:h-[50rem] border">
                ...
                {/*Vision and Story*/ }
            <div className="w-85% md:w-1/2 md:h-95% text-white flex 2xl:pl-32 md:overflow-auto scrollbar-hide 2xl:h-[50rem] border">
